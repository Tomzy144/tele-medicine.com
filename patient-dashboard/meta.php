...
<link href="<?php echo $website_url?>patient-dashboard/style/icons-1.10.2/font/bootstrap-icons.css" type="text/css" rel="stylesheet" >
<link href="<?php echo $website_url?>patient-dashboard/style/animate.css" type="text/css" rel="stylesheet" media="all">
<link href="<?php echo $website_url?>patient-dashboard/style/aos.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url?>patient-dashboard/style/styles.css" type="text/css" rel="stylesheet" />
