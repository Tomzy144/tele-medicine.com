...
<head>
    ...
    <title><?php echo $thename ?> | doctor Dashboard</title>
    <meta name="keywords" content="doctor - <?php echo $thename ?>" />
    <meta name="description" content="doctor Dashboard <?php echo $thename ?>" />
    ...
    <script>
        ...
        window.onload = function() {
            ...
            // document.getElementById('doctor_id').textContent = sessionId;
    ...
    <header>
        ...
        <div class="logo-div">
            ...
            <div class="list-div">
                <ul>
                    <li>
                        <p  id="first" class="first active" onclick="_next_page('next_1'),highlite2('first'), remove_heading(), get_doctor_details(sessionId);">
